...
class AddAdminQuest final : public userver::server::handlers::HttpHandlerBase {
 public:
  static constexpr std::string_view kName = "handler-v1-add-admin-quest";

  AddAdminQuest(const userver::components::ComponentConfig& config,
  ...
  std::string HandleRequestThrow(
    ...
    auto quest_id = userver::utils::generators::GenerateUuid();
...
void AppendAddAdminQuest(userver::components::ComponentList& component_list) {
  component_list.Append<AddAdminQuest>();
}
